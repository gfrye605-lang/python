...
num_label.configure(background="Black", width=64, height=7)
...
Button_1.grid(row=1, column= 0, padx=(0,240), pady=(15,0))
Button_2.grid(row=1, column= 0, padx=(27,0) ,pady=(15,0))
Button_3.grid(row=1, column= 0, padx=(293,0) ,pady=(15,0))
Button_4.grid(row=2, column= 0, padx=(0,240), pady=(15,0))
Button_5.grid(row=2, column= 0, padx=(27,0) ,pady=(15,0))
Button_6.grid(row=2, column= 0, padx=(293,0) ,pady=(15,0))
Button_7.grid(row=3, column= 0, padx=(0,240), pady=(15,0))
Button_8.grid(row=3, column= 0, padx=(27,0) ,pady=(15,0))
Button_9.grid(row=3, column= 0, padx=(293,0) ,pady=(15,0))
Button_dot.grid(row=4, column= 0, padx=(0,240), pady=(15,0))
Button_0.grid(row=4, column= 0, padx=(27,0) ,pady=(15,0))
Button_Equals.grid(row=4, column= 0, padx=(293,0) ,pady=(15,0))
